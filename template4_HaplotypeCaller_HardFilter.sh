# Variant Calling  
# Analysis ready BAM file --> VCF file (filtered)--> high confidence SNPs 
...
java -XmxXCallMemory XGATK_path -l INFO \
							...
							--filterExpression "QD < 2.0 || FS > 60.0 || MQ < 40.0 || HaplotypeScore > 13.0 || MappingQualityRankSum < -12.5 || ReadPosRankSum < -8.0" \ -filterName "my_snp_filter1" \
